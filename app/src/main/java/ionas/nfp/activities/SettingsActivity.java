...
import ionas.nfp.R;
import ionas.nfp.notification.AlarmSupervisor;
...
public class SettingsActivity extends Activity {
	...
	private void setInfo() {
		if (NfpPreferences.rtnPrefBool(context, NfpPreferences.SLOWO_CODZIENNIE_KEY)) {
			...
			String info = NfpPreferences.INFO_DAILY_VERSES_TIME + Utils.toTimeString(NfpPreferences.rtnPrefLong(context, NfpPreferences.DAILY_WAKE_UP_KEY));
